...
imdb_excel <- readxl::read_excel("dados/imdb.xlsx")
readxl::excel_sheets("dados/imdb.xlsx")
...
# CSV
readr::write_csv(imdb, file = "imdb.csv")


# Excel
library(writexl)
writexl::write_xlsx()(imdb, path = "imdb.xlsx")
